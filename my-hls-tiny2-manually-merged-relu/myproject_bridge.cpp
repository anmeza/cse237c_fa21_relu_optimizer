...
void myproject_float(
    ...
    hls::stream<layer18_t> layer18_out_ap("layer18_out");

    myproject(input_1_ap,layer18_out_ap,const_size_in_1,const_size_out_1);

    nnet::convert_data<layer18_t, float, N_LAYER_18>(layer18_out_ap, layer18_out);
}
...
void myproject_double(
    ...
    nnet::convert_data<layer18_t, double, N_LAYER_18>(layer18_out_ap, layer18_out);
}
