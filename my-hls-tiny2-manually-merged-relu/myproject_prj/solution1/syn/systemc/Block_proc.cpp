...
const sc_lv<16> Block_proc::ap_const_lv16_C00 = "110000000000";
const sc_lv<16> Block_proc::ap_const_lv16_A = "1010";
...
void Block_proc::thread_const_size_in_1() {
    const_size_in_1 = ap_const_lv16_C00;
}
...
void Block_proc::thread_const_size_out_1() {
    const_size_out_1 = ap_const_lv16_A;
}

void Block_proc::thread_const_size_out_1_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
