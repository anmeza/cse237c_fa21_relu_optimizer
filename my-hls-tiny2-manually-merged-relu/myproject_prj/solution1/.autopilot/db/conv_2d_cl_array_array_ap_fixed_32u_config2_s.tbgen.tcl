set moduleName conv_2d_cl_array_array_ap_fixed_32u_config2_s
set isTopModule 0
...
set C_modelName {conv_2d_cl<array,array<ap_fixed,32u>,config2>}
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V_data_0_V int 8 regular {axi_s 0 volatile  { data_V_data_0_V Data } }  }
	{ data_V_data_1_V int 8 regular {axi_s 0 volatile  { data_V_data_1_V Data } }  }
	{ data_V_data_2_V int 8 regular {axi_s 0 volatile  { data_V_data_2_V Data } }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "data_V_data_0_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "data_V_data_1_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "data_V_data_2_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_V_data_0_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "data_V_data_0_V", "role": "TDATA" }} , 
 	...
 	{ "name": "data_V_data_1_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "data_V_data_1_V", "role": "TDATA" }} , 
 	...
 	{ "name": "data_V_data_2_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "data_V_data_2_V", "role": "TDATA" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2048", "EstimateLatencyMax" : "102400",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "kernel_data_V_2240", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "kernel_data_V_0", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "kernel_data_V_1239", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "w2_V", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "pX_4", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "sX_4", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.outidx7_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.w2_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_mux_325_14_1_1_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_data_V_data_0_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_data_V_data_1_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_data_V_data_2_V_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	conv_2d_cl_array_array_ap_fixed_32u_config2_s {
		...
		kernel_data_V_2240 {Type IO LastRead -1 FirstWrite -1}
		kernel_data_V_0 {Type IO LastRead -1 FirstWrite -1}
		kernel_data_V_1239 {Type IO LastRead -1 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2048", "Max" : "102400"}
	, {"Name" : "Interval", "Min" : "2048", "Max" : "102400"}
]}
...
set Spec2ImplPortList { 
	data_V_data_0_V { axis {  { data_V_data_0_V_TDATA in_data 0 8 }  { data_V_data_0_V_TVALID in_vld 0 1 }  { data_V_data_0_V_TREADY in_acc 1 1 } } }
	data_V_data_1_V { axis {  { data_V_data_1_V_TDATA in_data 0 8 }  { data_V_data_1_V_TVALID in_vld 0 1 }  { data_V_data_1_V_TREADY in_acc 1 1 } } }
	data_V_data_2_V { axis {  { data_V_data_2_V_TDATA in_data 0 8 }  { data_V_data_2_V_TVALID in_vld 0 1 }  { data_V_data_2_V_TREADY in_acc 1 1 } } }
